function initMap() {
    ...
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(function (position) {
            ...
            //document.getElementById('check').value = parseFloat(document.getElementById('longitude').value);
        }, function () {
    ...
    document.getElementById('shop').addEventListener('change', onChangeHandler);
}
...
function calculateAndDisplayRoute(directionsDisplay, directionsService, markerArray, stepDisplay, map) {
    ...
    var waypts = [];
    var array = document.getElementById('shop');
    waypts.push({
